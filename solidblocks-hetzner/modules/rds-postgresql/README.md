...
| <a name="input_postgres_major_version"></a> [postgres\_major\_version](#input\_postgres\_major\_version) | PostgreSQL version to use, currently only version 14 is supported | `number` | n/a | yes |
